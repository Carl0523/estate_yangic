  ...
  return (
    <Overlay>
      <motion.div
        ...
        className="flex flex-col gap-2 items-center fixed px-3 py-5 md:w-[40%] w-[80%] top-1/2 left-1/2 bg-white shadow-card rounded-lg z-50"
      >                 
        <IoCloseCircleOutline
          className="text-2xl self-end cursor-pointer"
          onClick={onCloseModal}
        />
        {img &&  <img src={img} className="object-cover w-1/2" />}
